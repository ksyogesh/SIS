	   ...
	   if(isNaN(form1.se7.value))
   {
     ...
     return (false);
	  ...
	  if((form1.se7.value < 0) || (form1.se7.value > 50)  ) {
        alert("Error: sub7 external marks should be witin 0 to 50!");
        form1.se7.focus();
        return false;
      }
...
<form id="form1" name="form1" method="post" action="add6thsemres.php">
...
<tr>
 <th>10AL61</th>
 <th>Management and Entrepreneurship</th>
...
<tr>
 <th>10CS62</th>
 <th>Unix Systems Programming</th>
...
<tr>
 <th>10CS65</th>
 <th>Computer Graphics and Visualization</th>
 <td>
...
<tr>
 <th>10CSL67</th>
 <th>Computer Graphics and Visualization  Laboratory</th>
  <td>
...
<tr>
 <th>10CSL68</th>
 <th>Unix Systems Programming and  Compiler Design Laboratory</th>
