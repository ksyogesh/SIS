...
$qry=mysql_query("insert into 1cs values('$college','$name','$usn',$sub1_tot,$sub2_tot,$sub3_tot,$sub4_tot,$sub5_tot,$sub6_tot,$sub7_tot,$sub8_tot,$total,'$res')");	
