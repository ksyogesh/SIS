...
<script type="text/javascript">
  ...
  function checkForm()
  {
   ...
   if((form1.si1.value< 0) || (form1.si1.value > 25)  ) {
        alert("Error: sub1 internal marks should be within 0 to 25!");
        form1.si1.focus();
        return false;
      }
	   if(isNaN(form1.se1.value))
   {
     ...
     return (false);
	  ...
	  if((form1.se1.value< 0) || (form1.se1.value> 100)  ) {
        alert("Error: sub1 external marks should be within 0 to 100!");
        form1.se1.focus();
        return false;
      }
 ...
 if((form1.si2.value.length < 0) || (form1.si2.value.length > 25)  ) {
        alert("Error: sub2 internal marks should be within 0 to 25!");
        form1.si2.focus();
        return false;
      }
	   ...
	   if(isNaN(form1.se2.value))
   {
     ...
     return (false);
	  ...
	  if((form1.se2.value < 0) || (form1.se2.value > 100)  ) {
        alert("Error: sub2 external marks should be within 0 to 100!");
        form1.se2.focus();
        return false;
      }
 ...
 if((form1.si3.value < 0) || (form1.si3.value > 25)  ) {
        alert("Error: sub3 internal marks should be within 0 to 25!");
        form1.si3.focus();
        return false;
      }
	   ...
	   if(isNaN(form1.se3.value))
   {
     ...
     return (false);
	  ...
	  if((form1.se3.value < 0) || (form1.se3.value > 100)  ) {
        alert("Error: sub3 external marks should be within 0 to 100!");
        form1.se3.focus();
        return false;
      }
...
if(isNaN(form1.si4.value))
 ...
 if((form1.si4.value < 0) || (form1.si4.value > 25)  ) {
        alert("Error: sub4 internal marks should be within 0 to 25!");
        form1.si4.focus();
        return false;
      }
	   ...
	   if(isNaN(form1.se4.value))
   {
     ...
     return (false);
	  ...
	  if((form1.se4.value < 0) || (form1.se4.value > 100)  ) {
        alert("Error: sub4 external marks should be within 0 to 100!");
        form1.se4.focus();
        return false;
      }
if(isNaN(form1.si5.value))
 ...
 if((form1.si5.value < 0) || (form1.si5.value > 25)  ) {
        alert("Error: sub5 internal marks should be within 0 to 25!");
        form1.si5.focus();
        return false;
      }
	  if(isNaN(form1.se5.value))
   {
     ...
     return (false);
	  ...
	  if((form1.se5.value < 0) || (form1.se5.value > 100)  ) {
        alert("Error: sub5 external marks should be within 0 to 100!");
        form1.se5.focus();
        return false;
      }
...
if(isNaN(form1.si6.value))
 ...
 if((form1.si6.value < 0) || (form1.si6.value > 25)  ) {
        alert("Error: sub6 internal marks should be within 0 to 25!");
        form1.si6.focus();
        return false;
      }
	  if(isNaN(form1.se6.value))
   {
     ...
     return (false);
	  ...
	  if((form1.se6.value < 0) || (form1.se6.value > 50)  ) {
        alert("Error: sub6 external marks should be within 0 to 50!");
        form1.se6.focus();
        return false;
      }
if(isNaN(form1.si7.value))
 ...
 if((form1.si7.value < 0) || (form1.si7.value > 25)  ) {
        alert("Error: sub7 internal marks should be within 0 to 25!");
        form1.si7.focus();
        return false;
      }
	   ...
	   if(isNaN(form1.se7.value))
   {
     ...
     return (false);
	  ...
	  if((form1.se7.value < 0) || (form1.se7.value > 50)  ) {
        alert("Error: sub7 external marks should be within 0 to 50!");
        form1.se7.focus();
        return false;
      }
if(isNaN(form1.si8.value))
   {
     alert("Error:sub8 internal marks should be no");
     form1.si8.focus();
     return (false);
   }
 if((form1.si8.value < 0) || (form1.si8.value > 25)  ) {
        alert("Error: sub8 internal marks should be within 0 to 25!");
        form1.si8.focus();
        return false;
      }
	  if(isNaN(form1.se8.value))
   {
     ...
     return (false);
	  ...
	  if((form1.se8.value < 0) || (form1.se8.value > 50)  ) {
        alert("Error: sub8 external marks should be within 0 to 50!");
        form1.se8.focus();
        return false;
      }
...
<body  bgcolor="#FFCCCC">
<form id="form1" name="form1" method="post" action="add1stsemres.php">

<h2 align="center">&nbsp; </h2>
<h2 align="center">Computer Science Department Student Result  </h2>
...
<tr>
 <th>10 CIV-13</th>
<th>Elements of Civil Engg. & Engineering Mechanics</th>
...
<tr>
 <th>10 EME-14</th>
<th>Elements of Mechanical Engg.</th>
...
<tr>
 <th>10 CIP-18</th>
<th>Constitution of India & Professional Ethics</th>
